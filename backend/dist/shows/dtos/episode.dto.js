...
exports.EpisodeOutput = void 0;
const graphql_1 = require("@nestjs/graphql");
const output_dto_1 = require("../../common/dtos/output.dto");
const episode_entity_1 = require("../entities/episode.entity");
let EpisodeOutput = class EpisodeOutput extends output_dto_1.CoreOutput {
};
__decorate([
    graphql_1.Field((type) => episode_entity_1.Episode, { nullable: true }),
    __metadata("design:type", episode_entity_1.Episode)
], EpisodeOutput.prototype, "episode", void 0);
EpisodeOutput = __decorate([
    graphql_1.ObjectType()
], EpisodeOutput);
exports.EpisodeOutput = EpisodeOutput;
